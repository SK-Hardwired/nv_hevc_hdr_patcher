...
def main():
    ...
    if not os.path.exists(args.infile) :
        print ('Error! Given input file name not found!')
        sys.exit()
    if not args.outfile :
        print ('Name to outfile not set. It will be generated automatically')
        args.outfile = join(os.path.dirname(args.infile),'out'+os.path.basename(args.infile))
